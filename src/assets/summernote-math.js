        ...
        'math':function(context){
            ...
            self.initialize = function(){
                ...
                let body=`<div class="form-group">
                    ...
                    <p><input id="note-latex` + i + `" class="form-control"></p>
                    <p>Preview: </p>
                    <div style="min-height:20px;"><span class="note-math-dialog1"></span></div>
    
                    <script>
                    var $mathElement = $('.note-math-dialog1');
                    var latexSpan = document.getElementById('note-latex` + i + `');

                    
                    latexSpan.addEventListener('keyup', renderMath);

                    function renderMath(){
                    	for(i = 0; i < $mathElement.length; i++) {
                    		var mathSpan = $mathElement[i];
            ...
            self.show = function(){
                ...
                let $mathSpan = self.$dialog.find('.note-math-dialog1');
                let $latexSpan = self.$dialog.find('#note-latex' + i);
                ...
                if ($selectedMathNode === null) {
                    ...
                    let hiddenLatex = $selectedMathNode.find('.note-latex' + i).text();
