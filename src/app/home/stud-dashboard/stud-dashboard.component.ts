...
@Component({
  ...
  styleUrls: ['./stud-dashboard.component.css', '../../styles/home.component.css', '../../styles/dashboard.css', '../../styles/parent.css', '../../styles/registration.css']
})
  ...
  getStudentDashboradData() {
    this.userService.executeGetRequest('studentDashboard').subscribe(
      res => {
        ...
        this.writeUpExams = res.writeUpExams;
    ...
    this.userService.executeGetRequest("submenus/" + 12).subscribe(
      res => {
        ...
        for (let i = 0; i < this.submenus.length; i++) {
          ...
          else if (this.submenus[i].menuName === 'Start Write-Up Test') {
            this.submenus[i]["count"] = this.writeUpExams;
          }
  ...
  navigateTo(url) {
    ...
    switch (url) {
      case "startTopic":
        ...
        this.router.navigate(['my-activity'], navigationStartTopic);
        break;
      case "resumeTopic":
        ...
        this.router.navigate(['my-activity'], navigationResumeTopic);
        break;
      case "startMock":
        ...
        this.router.navigate(['my-activity'], navigationStartMock);
        break;
      case "resumeMock":
        ...
        this.router.navigate(['my-activity'], navigationResumeMock);
        break;
      ...
      case "result":
        ...
        this.router.navigate(['my-activity'], navigationResult);
        break;
      case "writeupTest":

        let navigationStartWriteUp: NavigationExtras = {
          queryParams: {
            examType: 'WRITEUP',
            status: 'PENDING'
          }
        }
        this.router.navigate(['my-activity'], navigationStartWriteUp);
        break;
      default:
