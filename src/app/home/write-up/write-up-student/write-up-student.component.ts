...
@Component({
  selector: 'app-write-up-student',
  templateUrl: './write-up-student.component.html',
  styleUrls: ['./write-up-student.component.css']
})
export class WriteUpStudentComponent implements OnInit {
    ...
    uploadFile(value) {
        ...
        formData.append("assignedId", this.id);
